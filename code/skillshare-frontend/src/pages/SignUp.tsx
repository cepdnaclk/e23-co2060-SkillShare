  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          <Link to="/" className="font-heading font-bold text-xl mb-8 block">
          ...
          <p className="text-muted-foreground mb-8">
            {isLogin
              ...
              : "Start connecting with fellow students today"}
          </p>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-primary/80 items-center justify-center p-12">
        ...
        >
          ...
          <p className="text-primary-foreground/80">
            Connect with students who share your interests and find the perfect time to learn together.
          </p>
        </motion.div>
      </div>
    </div>
