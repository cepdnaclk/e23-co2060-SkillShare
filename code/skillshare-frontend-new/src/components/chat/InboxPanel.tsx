  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 border-b border-border bg-background">
        <h3 className="text-sm font-semibold text-foreground tracking-wide">Messages</h3>
        <p className="text-[11px] text-muted-foreground mt-0.5">Your conversations</p>
      </div>
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    {chat.contactProfilePicture ? (
                      ...
                      <div className="w-9 h-9 rounded-full bg-primary/10 flex items-center justify-center text-[11px] font-bold text-primary shadow-sm">
                    ...
                    {chat.unreadCount > 0 && (
                      <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full bg-primary border-2 border-background flex items-center justify-center">
                        <span className="text-[8px] text-primary-foreground font-bold leading-none">
