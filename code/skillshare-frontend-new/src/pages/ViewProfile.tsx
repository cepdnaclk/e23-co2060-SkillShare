  ...
  const handleBook = async () => {
    ...
    try {
      ...
      if (id)
        availabilityApi
          .getMentorSlots(id)
          .then((av) => setSlots(av.filter((a) => !a.isBooked)));
    } catch (err: unknown) {
      const e = err as ApiError;
        ...
        <div className="p-6 md:p-8 max-w-2xl mx-auto pb-24 md:pb-8">
          ...
          >
            <div className="relative inline-block">
              ...
              <span
                className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-emerald-400 border-2 border-background"
                title="Online"
              />
            </div>
            ...
            <Button
              ...
              onClick={() =>
                navigate("/create-profile", { state: { startStep: 1 } })
              }
            >
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-medium flex items-center gap-1.5">
                  <GraduationCap className="w-4 h-4 text-primary" /> Skills I
                  Teach
                </h3>
                <Button
                  variant="ghost"
                ...
                {teachSkills.map((us) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      disabled={
                        deletingSkill === `${us.id.skillId}-${us.id.skillType}`
                      }
          ...
          {learnSkills.length > 0 && (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-medium flex items-center gap-1.5">
                  <BookOpen className="w-4 h-4 text-accent" /> Skills I'm
                  Learning
                </h3>
                <Button
                  variant="ghost"
        ...
        <Dialog open={bookingOpen} onOpenChange={setBookingOpen}>
          <DialogContent className="bg-card border-border max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Select the skill and a time slot to book with {mentor.fullName}.
              </DialogDescription>
            </DialogHeader>
